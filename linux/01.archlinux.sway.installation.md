...
```shell
pacstrap /mnt base linux-lts linux-firmware base-devel mesa xf86-video-intel vulkan-intel libva libva-mesa-driver alsa-utils pipewire pipewire-alsa pipewire-pulse pipewire-jack pipewire-zeroconf cifs-utils pcmanfm-gtk3 blueberry gnome-keyring ffmpeg tmux neovim tree zsh man-db man-pages texinfo terminus-font iwd grub efibootmgr intel-ucode sddm sway swaylock swayidle foot mako pcmanfm-gtk3
```
