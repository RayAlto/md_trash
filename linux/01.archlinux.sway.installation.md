...
```shell
pacstrap /mnt base linux-lts linux-firmware intel-ucode base-devel mesa vulkan-intel glfw-wayland libva libva-mesa-driver alsa-utils pipewire pipewire-alsa pipewire-pulse pipewire-jack pipewire-zeroconf cifs-utils blueberry gnome-keyring ffmpeg tmux neovim tree zsh man-db man-pages texinfo terminus-font iwd grub efibootmgr sddm sway swaylock swayidle swaybg qt5-wayland qt6-wayland qt5ct kvantum adapta-gtk-theme papirus-icon-theme xcursor-vanilla-dmz-aa foot mako pcmanfm-gtk3 polkit brightnessctl grim slurp wl-clipboard jq wf-recorder v4l2loopback-dpms xdg-desktop-portal xdg-desktop-portal-wlr gnu-netcat
```
